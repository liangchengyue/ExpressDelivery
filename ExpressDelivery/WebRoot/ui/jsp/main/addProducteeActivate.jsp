...
<html>
  <head>
	...
	-->
<link rel="stylesheet" type="text/css" href="../ui/css/addProducterActivate.css">
  </head>
...
<form action="" method="post">
	...
	活动开始时间：<input type="text" class="input1"/><br>
	活动结束时间：<input type="text" class="input1"/><br>
	活动内容：<textarea></textarea><br>
